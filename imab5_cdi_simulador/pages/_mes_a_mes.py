...
def _build_vna_full(df_hist, data_inicio, data_fim, holidays):
    ...
    Usa histórico ANBIMA onde disponível, projeta o restante com o cenário IPCA ativo.
    """
    result = {}
    ...
    # Projeção: usa cenário IPCA ativo
    ...
    ipca_map  = build_ipca_monthly_map(ipca_df, ultima_hist, data_fim)
    vna_ponto = result[ultima_hist]

    df_proj = project_vna_daily(ultima_hist, data_fim, vna_ponto, ipca_map, holidays)
